...
namespace Swissup\Msrp\Ui\DataProvider\Product\Form\Modifier;

use Magento\Catalog\Model\Locator\LocatorInterface;
use Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AbstractModifier;
use Magento\Msrp\Model\Config as MsrpConfig;
use Magento\Framework\Stdlib\ArrayManager;
use Swissup\Msrp\Helper\Data as DataHelper;
...
class Msrp extends AbstractModifier
{
    ...
    protected function customizeMsrp()
    {
        ...
        if ($msrpPath) {
            if ($this->helper->isEnabled() || $this->msrpConfig->isEnabled()) {
